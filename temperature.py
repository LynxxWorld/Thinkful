...
api_key = "0796f9debd90fe8ab790200ad0e9b895"
...
# Setting this equal to a variable, we fix the calculation to the point when we started the script (rather than have things move around while we're coding.)
...
with con:
    while query_date < end_date:
        cur.execute("INSERT INTO daily_temp(day_of_reading) VALUES (?)", (int(query_date.strftime('%Y-%m-%dT%H:%M:%S ')),))
